...
来源：当前 `CleanroomModTemplate`、Cleanroom Website 的 Forge 模组开发资料及固定提交，详见 [`official-docs.md`](../official-docs.md)。
...
- 旧版入口和侧隔离仍遵循 Forge 1.12.2 的 `@Mod`、FML 生命周期、`@SidedProxy`/物理侧类加载规则。
